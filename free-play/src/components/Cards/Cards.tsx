...
import IconCrown from '../../Img/cardCrown.png'
import IconControler from '../../Img/cardControler.png'
import IconSword from '../../Img/cardSword.png'
export const Cards = () => {
    return (
...
<C.CardSpan>Melhores jogos gratuitos para jogar com seus amigos</C.CardSpan>
        </C.CardInfo>
    </C.Card>
    <C.Card>
        <C.CardIcon>
...
<img src={IconCrown} alt="" />
        ...
        <C.CardInfo>
<C.CardTitle>
POPULARES DO MOMENTO</C.CardTitle>
