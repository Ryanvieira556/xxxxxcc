...
<C.ContainerCreditsSpan>
          ...
          <C.ContainerCreditsMore href="https://davidaugusto.tech/"> David Augusto</C.ContainerCreditsMore>
        </C.ContainerCreditsSpan>
        <C.ContainerCreditsSpan>
          Sistema desenvolvido por 
          <C.ContainerCreditsMore href="www.linkedin.com/in/Ryan-Front"> Ryan Vieira</C.ContainerCreditsMore>
        </C.ContainerCreditsSpan>
</C.ContainerCreditsLinks>
